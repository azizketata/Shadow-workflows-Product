...
class ComplianceEngine:
    ...
    def _build_classification_prompt(self, agenda_tasks, window_events, visual_context=""):
        ...
        return (
            ...
            "Shadow: <specific topic-based label>\n"
            "   Shadow labels MUST describe the actual topic or subject from the transcript text. "
            "   BAD: 'Shadow: Informal Discussion' (too vague)\n"
            "   GOOD: 'Shadow: Off-agenda debate on parking enforcement'\n"
            "   GOOD: 'Shadow: Side conversation about upcoming election'\n"
            "   GOOD: 'Shadow: Unscheduled discussion of water utility rates'\n"
            "   Include the SUBJECT MATTER so the label is informative on its own.\n"
            ...
            "Events: two council members whispering about the new park project between agenda items "
            "-> Return: Shadow: Side conversation about new park project\n"
            "Events: off-agenda discussion of traffic complaints near downtown "
            "-> Return: Shadow: Unscheduled discussion of downtown traffic complaints\n"
