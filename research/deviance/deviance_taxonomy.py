...
DEVIANCE_RULES: dict[str, DevianceCategory] = {
    ...
    r"technical.*difficult|audio.*issue|connection": DevianceCategory.EXTERNAL_DISRUPTION,
    ...
    r"fire.*alarm|emergency|evacuat": DevianceCategory.EXTERNAL_DISRUPTION,
    r"protester|disruption|outburst|removed.*from": DevianceCategory.EXTERNAL_DISRUPTION,
}
